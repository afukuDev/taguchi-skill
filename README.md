...
### 実践例：Web API レスポンスタイム最適化

**目標：** APIの平均レスポンスタイム（ms）を最小化 — 望小。

| 因子 | 水準1 | 水準2 | 水準3 |
|------|-------|-------|-------|
| A — DBクエリキャッシュ | 無効 | 256 MB | 1 GB |
| B — Workerプロセス数 | 2 | 4 | 8 |
| C — 接続タイムアウト | 5秒 | 15秒 | 30秒 |
...
| 4 | 256 MB | 2 | 15s | 390 |
| 5 | 256 MB | 4 | 30s | 195 |
| **6** | **256 MB** | **8** | **5s** | **140 ← 最適** |
| 7 | 1 GB | 2 | 30s | 370 |
| 8 | 1 GB | 4 | 5s | 160 |
| 9 | 1 GB | 8 | 15s | 175 |

**最も重要な因子：B（Workerプロセス数）** — 並行処理数の増加がキュー遅延の削減に最も効果的。
